...
import com.nexty.demandante.domain.Authority;
...
import com.nexty.demandante.service.mapper.UserMapper;
...
class UserResourceIT {
    ...
    private static final String DEFAULT_URL = "http://placehold.it/50x50";
    private static final String UPDATED_URL = "http://placehold.it/40x40";
    ...
    void createUser() throws Exception {
        ...
        managedUserVM.setUrl(DEFAULT_URL);
        ...
        assertPersistedUsers(users -> {
            ...
            assertThat(testUser.getUrl()).isEqualTo(DEFAULT_URL);
    ...
    void updateUser() throws Exception {
        ...
        managedUserVM.setUrl(UPDATED_URL);
        ...
        assertPersistedUsers(users -> {
            ...
            assertThat(testUser.getUrl()).isEqualTo(UPDATED_URL);
    ...
    void updateUserExistingEmail() throws Exception {
        ...
        managedUserVM.setActivated(updatedUser.isActivated());
        managedUserVM.setUrl(updatedUser.getUrl());
    ...
    void testUserDTOtoUser() {
        ...
        assertThat(user.getUrl()).isEqualTo(DEFAULT_URL);
    ...
    void testUserToUserDTO() {
        ...
        assertThat(userDTO.getUrl()).isEqualTo(DEFAULT_URL);
