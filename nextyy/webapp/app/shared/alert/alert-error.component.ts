...
import { EventManager, EventWithContent } from 'webapp/app/core/util/event-manager.service';
...
export class AlertErrorComponent implements OnDestroy {
  ...
  constructor(private alertService: AlertService, private eventManager: EventManager) {
    this.errorListener = eventManager.subscribe('nextyDemandanteApp.error', (response: EventWithContent<unknown> | string) => {
      const errorResponse = (response as EventWithContent<AlertError>).content;
      this.addErrorAlert(errorResponse.message);
    });

    this.httpErrorListener = eventManager.subscribe('nextyDemandanteApp.httpError', (response: EventWithContent<unknown> | string) => {
