...
import com.nexty.service.EnderecoService;
...
/**
 * REST controller for managing {@link com.nexty.domain.Endereco}.
 */
@RestController
@RequestMapping("/api")
public class EnderecoResource {
    ...
    public List<EnderecoDTO> getAllEnderecos(@RequestParam(required = false) String filter) {
        if ("demandante-is-null".equals(filter)) {
            log.debug("REST request to get all Enderecos where demandante is null");
            return enderecoService.findAllWhereDemandanteIsNull();
        }
